                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item statistic__item--green">
                            <h2 class="number">{{$dashboard_data["total_users"]}}</h2>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item statistic__item--orange">
                            <h2 class="number">{{$dashboard_data["total_items_sold"]}}</h2>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item statistic__item--blue">
                            <h2 class="number">{{$dashboard_data["num_orders_this_week"]}}</h2>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item statistic__item--red">
                            <h2 class="number">${{$dashboard_data["total_value_of_items_sold"]}}</h2>
